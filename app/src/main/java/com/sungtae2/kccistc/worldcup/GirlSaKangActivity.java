...
public class GirlSaKangActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_girl_sa_kang);
        ...
        leftButton.setOnClickListener(new View.OnClickListener() {       //버튼을 실행할때 사용되는 메소드들과 값들의 움직임들을 넣어놓는곳 앞
            ...
            public void onClick(View view) {                                           //자동으로 생성되는 곳  위에 new V 에서 엔터
                Intent intent = new Intent(GirlSaKangActivity.this, GirlPalkangLast.class);      //현재 엑티비티에서 다음엑티비티로 넘어간다를 정의해놈
        ...
        rightButton.setOnClickListener(new View.OnClickListener() {   //오른쪽 버튼이미지 클릭시에 실행되는 메소드 시작
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GirlSaKangActivity.this,GirlPalkangLast.class);  //다음 엑티비티 넘어간다.
